...
ethernet:
	...
	;mov eax,68
	;mov ecx,[dhcpClientIP]
	;int 0x40 ; le suicide ne fonctionne pas .... envoyer au kernel l'adresse ip init
	; après démarrer le petit server de fichier
	;mov eax,-1
	;int 0x40
...
text:
    ...
    db   'appel depuis le nouveau programme uqi va appeller le kernel call de gaspard',0
